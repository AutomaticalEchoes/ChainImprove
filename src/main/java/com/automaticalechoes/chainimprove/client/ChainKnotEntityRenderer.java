...
public class ChainKnotEntityRenderer extends EntityRenderer<ChainKnotEntity> {
    ...
    private final LeashKnotModel<ChainKnotEntity> model;

    public ChainKnotEntityRenderer(EntityRendererProvider.Context p_174284_) {
        super(p_174284_);
        this.model = new LeashKnotModel<>(p_174284_.bakeLayer(ModelLayers.LEASH_KNOT));
    }

    public void render(ChainKnotEntity p_115246_, float p_115247_, float p_115248_, PoseStack p_115249_, MultiBufferSource p_115250_, int p_115251_) {
        p_115249_.pushPose();
    ...
    public ResourceLocation getTextureLocation(ChainKnotEntity p_115244_) {
